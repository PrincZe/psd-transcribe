...
def process_audio_data():
    try:
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as temp_audio:
            ...
            s3.upload_file(temp_audio.name, bucket_name, os.path.basename(temp_audio.name))
            temp_audio_uri = f"https://{bucket_name}.s3.amazonaws.com/{os.path.basename(temp_audio.name)}"
